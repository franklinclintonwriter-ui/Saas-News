...
CREATE TABLE "SiteSetting" (
    ...
    "siteTitle" TEXT NOT NULL DEFAULT 'Phulpur24',
    "tagline" TEXT NOT NULL DEFAULT 'Verified local news, analysis, and updates from Phulpur',
    ...
    "defaultSeoTitle" TEXT NOT NULL DEFAULT 'Phulpur24 - Local News, Analysis and Updates',
    ...
    "copyright" TEXT NOT NULL DEFAULT '(c) 2026 Phulpur24. All rights reserved.',
    ...
    "contactEmail" TEXT NOT NULL DEFAULT 'contact@phulpur24.com',
    "supportEmail" TEXT NOT NULL DEFAULT 'support@phulpur24.com',
    ...
    "newsletterFromName" TEXT NOT NULL DEFAULT 'Phulpur24 Team',
    "newsletterFromEmail" TEXT NOT NULL DEFAULT 'newsletter@phulpur24.com',
